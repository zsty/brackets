...
define(function(require, exports, module) {
  ...
  var fs = BracketsFiler.fs(), Path = BracketsFiler.Path, watchers = {};
  ...
  function showOpenDialog(
    ...
    throw new Error(
      "Filer dialogs not supported. See: https://github.com/humphd/brackets/pull/309"
    );
  }
