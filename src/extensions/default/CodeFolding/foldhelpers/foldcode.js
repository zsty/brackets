...
define(function(require, exports, module) {
  ...
  function doFold(cm, pos, options, force) {
    ...
    function getRange(allowFolded) {
      ...
      if (
        !range ||
        range.to.line - range.from.line < prefs.getSetting("minFoldSize")
      ) {
        return null;
      }
      var marks = cm.findMarksAt(range.from), i, lastMark, foldMarks;
      ...
      if (marks && marks.length) {
        ...
        if (foldMarks && foldMarks.length) {
          ...
          if (
            lastMark &&
            range.from.line <= lastMark.to.line &&
            lastMark.to.line < range.to.line
          ) {
            return null;
          }
        }
        ...
        keys.forEach(function(lineNumber) {
          ...
          if (lineNumber >= cm.firstLine() && lineNumber <= cm.lastLine()) {
            ...
            if (
              range &&
              cachedRange &&
              range.from.line === cachedRange.from.line &&
