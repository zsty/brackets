...
define(function(require, exports, module) {
  ...
  // Orientation
  var VERTICAL_ORIENTATION = 0, HORIZONTAL_ORIENTATION = 1;
  ...
  function detachPreview() {
    ...
    return Compatibility.supportsIFrameHTMLBlobURL(
      function(err, shouldUseBlobURL) {
        if (err) {
          console.error("[Brackets IFrame-Browser] Unexpected error:", err);
          return;
        }
        ...
        StatusBar.addIndicator(
          ...
          true,
          "",
          "Click to return preview to current window",
          "mobileViewButtonBox"
        );
