...
(function(global) {
  ...
  function XMLHttpRequestLiveDev() {
        ...
        switch (_responseType) {
          ...
          default:
            ...
            handleError(
              "Response type of " +
                _responseType +
                " is not supported. Response type must be `text`, `document` or `json`."
            );
            return;
        }
    ...
    Object.defineProperties(self, {
      onreadystatechange: {
        get: function() {
          return _requestUrl ? _onreadystatechange : xhr.onreadystatechange;
        },
        set: function(fn) {
      ...
      onload: {
        get: function() {
          return _requestUrl ? _onload : xhr.onload;
        },
        set: function(fn) {
          _onload = (xhr.onload = fn);
        }
      },
      onerror: {
        get: function() {
          return _requestUrl ? _onerror : xhr.onerror;
        },
        set: function(fn) {
          _onerror = (xhr.onerror = fn);
        }
      },
      readyState: {
        get: function() {
          return _requestUrl ? _readyState : xhr.readyState;
        }
      },
      response: {
        get: function() {
          return _requestUrl ? _response : xhr.response;
        }
      },
      responseText: {
        get: function() {
          return _requestUrl ? _responseText : xhr.responseText;
        }
      },
      responseType: {
        get: function() {
          return _requestUrl ? _responseType : xhr.responseType;
        },
        set: function(value) {
      ...
      responseXML: {
        get: function() {
          return _requestUrl ? null : xhr.responseXML;
        }
      },
      status: {
        get: function() {
          return _requestUrl ? _status : xhr.status;
        }
      },
      statusText: {
        get: function() {
          return _requestUrl ? _statusText : xhr.statusText;
        }
      },
      timeout: {
        get: function() {
          return _requestUrl ? null : xhr.timeout;
        },
        set: function(value) {
          if (!_requestUrl) {
            xhr.timeout = value;
      ...
      ontimeout: {
        get: function() {
          return _requestUrl ? null : xhr.ontimeout;
        },
        set: function(fn) {
          if (!_requestUrl) {
            xhr.ontimeout = fn;
      ...
      upload: {
        get: function() {
          return _requestUrl ? null : xhr.upload;
        }
      },
      withCredentials: {
        get: function() {
          return _requestUrl ? null : xhr.withCredentials;
        },
        set: function(value) {
          if (!_requestUrl) {
