...
define(function(require, exports, module) {
  ...
  var AppInit = brackets.getModule("utils/AppInit"),
    ...
    FileSystemCache = brackets.getModule(
      "filesystem/impls/filer/FileSystemCache"
    ),
  ...
  function handleMessage(message) {
    ...
    var currentDir = currentDocPath !== currentDocUrl
      ? Path.dirname(currentDocPath)
      : currentDocPath;
    var requestedPath;
    ...
    try {
      ...
      console.error(
        "[Brackets Browser LiveDev Error] Cannot handle message ",
        message
      );
      return;
    }
      ...
      deferred.always(function() {
        ...
        FileSystemCache.refresh(function(err) {
          if (err) {
            ...
            console.warn(
              "[Bramble] unable to preload all filesystem Blob URLs",
              err
            );
          }
  ...
  function init(e) {
    ...
    window.addEventListener(
      "message",
      RemoteCommandHandler.handleRequest,
      false
    );
